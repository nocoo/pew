...
│  Hermes · Kosmos · OpenCode · OpenClaw · Pi · PM Studio · VS Code│
└───────────────┬──────────────────────────────────────────────────┘
...
- **12 种 AI 工具** — Claude Code、Codex、Gemini CLI、GitHub Copilot CLI、Grok、Hermes、Kosmos、OpenCode、OpenClaw、Pi、PM Studio、VS Code Copilot
