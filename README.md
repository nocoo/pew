...
│  Hermes · Kosmos · OpenClaw · OpenCode · Pi · PM Studio · VS Code│
└───────────────┬──────────────────────────────────────────────────┘
...
- **12 种 AI 工具** — Claude Code、Codex、Gemini CLI、GitHub Copilot CLI、Grok、Hermes、Kosmos、OpenClaw、OpenCode、Pi、PM Studio、VS Code Copilot
...
- **通知钩子** — `pew init` 一键为 6 种工具（Claude Code、Codex、Gemini CLI、OpenClaw、OpenCode、Pi）安装 hook，会话结束后自动触发同步；其余 6 种（GitHub Copilot CLI、Grok、Hermes、Kosmos、PM Studio、VS Code Copilot）无 hook 机制，靠下一次 `pew sync` 拉取
