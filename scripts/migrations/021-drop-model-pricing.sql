...
--   UI (/admin/pricing — Token Pricing CRUD page), the legacy CRUD API
--   route (/api/admin/pricing), web RPC methods
...
--   bunx wrangler kv key delete pricing:all \
--     --config packages/worker-read/wrangler.toml --binding=CACHE --remote
-- ============================================================
